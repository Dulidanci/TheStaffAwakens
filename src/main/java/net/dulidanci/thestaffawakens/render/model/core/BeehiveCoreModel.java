...
public class BeehiveCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/beehive_core.png");
    private final ModelPart root;

    public BeehiveCoreModel(ModelPart root) {
