...
public class CherryPlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/cherry_planks_core.png");
    private final ModelPart root;

    public CherryPlanksCoreModel(ModelPart root) {
