...
public class JunglePlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/jungle_planks_core.png");
    private final ModelPart root;

    public JunglePlanksCoreModel(ModelPart root) {
