...
public class DarkOakPlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/dark_oak_planks_core.png");
    private final ModelPart root;

    public DarkOakPlanksCoreModel(ModelPart root) {
