...
public class LapisLazuliCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/lapis_lazuli_core.png");
    private final ModelPart root;

    public LapisLazuliCoreModel(ModelPart root) {
