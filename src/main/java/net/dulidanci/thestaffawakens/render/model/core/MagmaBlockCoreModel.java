...
public class MagmaBlockCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/magma_block_core.png");
    private final ModelPart root;

    public MagmaBlockCoreModel(ModelPart root) {
