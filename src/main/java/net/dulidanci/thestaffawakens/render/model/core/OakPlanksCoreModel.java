...
public class OakPlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/oak_planks_core.png");
    private final ModelPart root;

    public OakPlanksCoreModel(ModelPart root) {
