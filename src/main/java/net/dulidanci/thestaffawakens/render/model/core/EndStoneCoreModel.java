...
public class EndStoneCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/end_stone_core.png");
    private final ModelPart root;

    public EndStoneCoreModel(ModelPart root) {
