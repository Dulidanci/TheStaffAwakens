...
public class BirchPlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/birch_planks_core.png");
    private final ModelPart root;

    public BirchPlanksCoreModel(ModelPart root) {
