...
public class MangrovePlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/mangrove_planks_core.png");
    private final ModelPart root;

    public MangrovePlanksCoreModel(ModelPart root) {
