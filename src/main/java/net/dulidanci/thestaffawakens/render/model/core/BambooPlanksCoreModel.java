...
public class BambooPlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/bamboo_planks_core.png");
    private final ModelPart root;

    public BambooPlanksCoreModel(ModelPart root) {
