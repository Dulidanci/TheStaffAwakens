...
public class SprucePlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/spruce_planks_core.png");
    private final ModelPart root;

    public SprucePlanksCoreModel(ModelPart root) {
