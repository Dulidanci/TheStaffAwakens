...
public class NetherrackCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/netherrack_core.png");
    private final ModelPart root;

    public NetherrackCoreModel(ModelPart root) {
