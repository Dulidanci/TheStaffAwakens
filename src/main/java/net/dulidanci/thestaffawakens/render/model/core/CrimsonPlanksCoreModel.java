...
public class CrimsonPlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/crimson_planks_core.png");
    private final ModelPart root;

    public CrimsonPlanksCoreModel(ModelPart root) {
