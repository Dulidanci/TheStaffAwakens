...
public class WarpedPlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/warped_planks_core.png");
    private final ModelPart root;

    public WarpedPlanksCoreModel(ModelPart root) {
