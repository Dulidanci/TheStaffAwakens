...
public class AcaciaPlanksCoreModel extends CoreModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/acacia_planks_core.png");
    private final ModelPart root;

    public AcaciaPlanksCoreModel(ModelPart root) {
