package net.dulidanci.thestaffawakens.render.model.staff;
...
public class PerfectedStaffModel extends StaffModel {
    private static final Identifier TEXTURE = new Identifier(TheStaffAwakens.MOD_ID, "textures/item/perfected_staff_3d.png");
